...
# reading the clinical information and expression data ------
  ...
  cm10$clinical <-
    read_excel('./data/checkmate/NIHMS1611472-supplement-Table_S1__Clinical_and_immune_phenotype_data_for_the_CheckMate_cohorts.xlsx',
               skip = 1)

  cm10$expression <-
    read_excel('./data/checkmate/NIHMS1611472-supplement-Table_S4__RNA_expression__normalized_expression_matrix_.xlsx',
