...
# Reading the data ------
  ...
  emtab1980$clinical <- read_excel('./data/EMTAB1980/clinical.xlsx',
                                   skip = 1)

  emtab1980$expression <- read_tsv('./data/EMTAB1980/expression.txt')

  emtab1980$annotation <- read_tsv('./data/EMTAB1980/annotation.txt',
                                   skip = 19) %>%
