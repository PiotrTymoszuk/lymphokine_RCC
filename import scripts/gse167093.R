...
# reading the data -------
  ...
  gse167093$expression_pairs <- 
    read_excel('./data/GSE167093/GSE167093_Pairs_normalization_matrix.xlsx')

  gse167093$expression <- 
    read_excel('./data/GSE167093/GSE167093_Tumor_only_norm_matrix.xlsx')

  gse167093$clinical <- 
    read_tsv('./data/GSE167093/clinical.csv')

  gse167093$annotation <- read_tsv('./data/GSE167093/GPL10558-50081.txt',
                                   skip = 30)
...
# Normal- Tumor pair expression ------
  ...
  gse167093$unique_genes <- 
    gse167093$annotation[26:nrow(gse167093$annotation), ] %>%
